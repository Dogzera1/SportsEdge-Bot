 ...
 *   2. opts.tier + opts.side: markets[market].tiers[tier].sides[side] (v2.1)
 *   3. opts.tier: markets[market].tiers[tier] (v2)
 *   4. opts.side: markets[market].sides[side] (v2.1 fallback sem tier match)
 *   5. markets[market] default bins (v1 fallback)
 *
...
function applyMarkovCalib(pRaw, market, opts = {}) {
  ...
  const pCalib = (() => {
    ...
    // Schema v2.1: tier+side bins se presente (mais específico)
