...
function _fetchTierRoisForSport(db, sport, startDays, endDays) {
  ...
  // tips usa coluna `event_name`; market_tips_shadow usa `league`. Não confundir.

  // 1) tips is_shadow=1 (ML shadow universe — usually) — capture event_name como league
  ...
  // 2) market_tips_shadow (MT shadow universe) — coluna `league` nativa
