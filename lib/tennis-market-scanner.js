 ...
 */
function scanTennisMarkets({ markov, aces, doubleFaults, markets, minEv = 4, bestOf = 3, maxEv = 40, maxEvPerMarket = null, minOdd, maxOdd, maxPerMatch, isLive = false, gamesScale = 1.0, shadowMinEv } = {}) {
  ...
  if (Number.isFinite(shadowMinEv) && shadowMinEv < minEv) {
    const promotable = scanTennisMarkets({
      ...
      minOdd, maxOdd, maxPerMatch, isLive, gamesScale,
