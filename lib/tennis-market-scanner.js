...
function scanTennisMarkets({ markov, aces, markets, minEv = 4, bestOf = 3, maxEv = 40 }) {
  ...
  // Dedup: 1 tip por (market, side). Linhas diferentes do mesmo mercado
  // (ex: Over 19.5, Over 20.5, Over 21.5) são correlacionadas — mantém só
  // a de maior EV. Override via TENNIS_MARKET_DEDUP=false.
