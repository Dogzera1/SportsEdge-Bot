...
const TIER_PATTERNS = {
  ...
  football: [
    ...
    { tier: 'tier1_top5', regex: /premier|laliga|la liga|serie a$|bundesliga|ligue 1/i },
    { tier: 'tier1_brazil_a', regex: /brasileirao serie a$|brasileirão serie a/i },
    { tier: 'tier2_second', regex: /serie b|championship|2\. bundesliga|brasileirao serie b/i },
