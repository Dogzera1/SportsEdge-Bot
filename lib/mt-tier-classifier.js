...
const TIER_PATTERNS = {
  tennis: [
    // Qualifier / R1 / R2 detected ANTES dos tiers de liga: audit 2026-05-04
    // mostrou early-round/quali underperform regardless of tier (high variance,
    // ranking gap unreliable, fitness desconhecido). \b protege contra falso
    // match em "R10"/"R128" (R128 fica fora — memo spec é r1|r2 literais).
    { tier: 'tier_quali_or_early', regex: /\bqualif|\bq[12]\b|\br[12]\b/i },
  ...
  valorant: [
    { tier: 'tier1_intl', regex: /vct.+masters|valorant.+masters|vct.+champions(?!.+tour)/i },
    { tier: 'tier2_franchised', regex: /champions tour.+(americas|pacific|emea)|vct.+(americas|pacific|emea)/i },
    { tier: 'tier3_challengers', regex: /challengers|vcl|ascension/i },
    { tier: 'tier4_game_changers', regex: /game changers/i },
  ],
};
...
const TIER_DEFAULT_MULT = {
  ...
  // Tennis: quali/R1/R2 high variance + ranking unreliable → 50% stake
  'tennis|tier_quali_or_early': 0.5,
