...
//
// 2026-05-28: REMOVIDOS 'academy', 'reserves', 'youth' — designam ROSTERS
// DIFERENTES (developmental squad), não decoração de marca. Root cause do P0
// LoL #4607: settle path Tentativa 2 fuzzy match retornou "T1 Academy vs
// KT Rolster Challengers" (LCK Challengers League) quando tip era "T1 vs
// kt Rolster" (LCK main). nameMatches('T1', 'T1 Academy') retornava match=true
// via token_prefix porque 'academy' estava listado como suffix. Pattern afeta
// LoL/CS/Valorant (Academy/Reserves/Junior rosters). Tests: tests/test-name-match.js.
