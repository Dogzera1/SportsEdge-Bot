...
const POLICY = {
  valorant: {
    ...
    tier3: { Bo1: { skip: true,  minEdgeBonus: 0, brier: 0.25, reason: 'Valorant tier3 sample muito pequeno' },
             Bo3: { skip: true,  minEdgeBonus: 0, brier: 0.25, reason: 'Valorant tier3 sample muito pequeno' } },
  },
  cs2: {
