...
// Kill-switch: TENNIS_ISOTONIC_DISABLED=true desativa o apply (bypass).
// Diag 2026-04-22 mostrou overshooting brutal na zona [0.40, 0.55) — block
// yMean=0.7419 inflava P=0.45 → 0.74, causando ROI -64% no bucket odds 2.20-3.00.
...
function _applyIsotonic(p) {
  if (/^(1|true|yes)$/i.test(String(process.env.TENNIS_ISOTONIC_DISABLED || ''))) return p;
