...
function _esportsTier(league) {
  ...
  // 2026-05-21: tier 2 PRECEDÊNCIA pra "challenger(s)" — bug discovered:
  // "LCK Challengers League" matchava /lck/ tier 1 ANTES de avaliar tier 2,
  // classificando feeder league como top. Audit P0: Kiwoom DRX Challengers
  // (LCK CL) @ 2.16 perdeu em LoL AI; com LOL_AI_TIER1_ONLY=true bug deixava
  // passar. Cross-sport: aplica pra qualquer "X Challengers/Challenger League"
  // (EU Challengers, EU Masters etc — todas feeder). Mirror do fix football
  // 2026-05-08 que reordena tier 2 antes de tier 1.
  if (/\bchallengers?\b|academy|game changers/.test(l)) return 2;
