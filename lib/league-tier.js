...
function _esportsTier(league) {
  ...
  if (/lck|lpl|lec|lcs|worlds|msi|first stand|the international|\bti\d*\b|major championship|valorant champions|vct masters|vct (americas|emea|pacific|china)|champions tour|iem (katowice|cologne|rio|sydney|dallas|chengdu|melbourne)|blast premier|blast (world final|spring final|fall final)|esl one (cologne|stockholm)|riyadh masters|pgl major/.test(l)) return 1;
...
function _footballTier(league) {
  ...
  if (/championship|la liga 2|serie b\b|bundesliga 2|ligue 2|brasileir.{1,4} b\b|copa sudamericana|primeira liga|eredivisie|jupiler|super lig|saudi pro|mls/.test(l)) return 2;
