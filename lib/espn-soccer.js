...
const LEAGUES = [
  ...
  'arg.1',
  'arg.2',  // Argentina Primera B Nacional (n=17 void-audit 2026-05-13)
  // Outras populares
  'ned.1',
  'por.1',
  'tur.1',
  ...
  'sco.1',
  'uefa.nations',
  'fifa.world',  // FIFA World Cup (sem este slug os jogos da Copa não entram em match_results → tips stuck)
  'fifa.worldq.uefa',
