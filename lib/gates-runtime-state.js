...
module.exports = {
  ...
  GATE_KEYS: {
    PRE_MATCH_EV_BONUS: 'pre_match_ev_bonus',
    MAX_STAKE_UNITS: 'max_stake_units',
    // MT scanner odd floor/cap auto-tunados via runMtBucketGuardCycle (cron 12h)
    // a partir do shadow per-bucket ROI. Substitui {SPORT}_MARKET_SCAN_MIN/MAX_ODD
    // quando env não setado.
    MT_SCAN_MIN_ODD: 'mt_scan_min_odd',
    MT_SCAN_MAX_ODD: 'mt_scan_max_odd',
  },
};
