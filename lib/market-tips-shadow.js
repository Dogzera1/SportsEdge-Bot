...
function settleShadowTips(db) {
  ...
  // Cleanup: markets sem settlement handler ficam NULL pra sempre e contaminam
  // queries de readiness/stats. Após 14d → void. totalAces/correctScore nunca
  // têm data ingerida; totalKills/duration exigem dados live (OpenDota) não
  // capturados em match_results.final_score; props afins.
  try {
