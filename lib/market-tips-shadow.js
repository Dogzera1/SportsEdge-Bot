...
function logShadowTip(db, args) {
  try {
    ...
    if (_hasIsLiveCol === null) {
      ...
      } catch (_) { _hasIsLiveCol = false; _hasModelVersionCol = false; _hasRegimeTagCol = false; _hasWouldBeRejectedByCol = false; _hasGateStateCol = false; _hasMatchStartAtCol = false; }
    }
