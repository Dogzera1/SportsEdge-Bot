...
/**
 * cs-live-pricing.js — pricing live-aware pra esports map-based (handicap + total maps).
 *
 * Apesar do nome legacy (criado pra CS first), é sport-agnostic: funciona pra
 * qualquer esport com séries Bo3/Bo5 onde pricing é derivado de pMap (P de
 * vencer um mapa). Reutilizado em CS, LoL, Valorant.
 *
 ...
 * pricing reagir ao estado in-play.
 *
 * Gap fechado (audit 2026-05-12): MT live shadow emite tips mas nenhuma
 * promovida pra real porque pMap pre-game stale durante live → pModel boundary
 * fica preso ~0.55 → falha gate <SPORT>_MARKET_TIP_MIN_PMODEL=0.55.
 *
