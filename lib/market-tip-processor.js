...
function kellyStakeForMarket(pModel, odd, totalBankrollUnits = 100, kellyFrac = MAX_KELLY_FRAC) {
  ...
  // 2026-05-01: HIGH_EV_THROTTLE — buckets EV>8% rodaram ROI -10% a -32% em 30d
  // (overall, lol, tennis, cs). Aplica corte multiplicativo idêntico ao
  // _applyKelly em lib/utils.js. Override via HIGH_EV_THROTTLE=false.
  let evThrottle = 1;
  ...
  const fractional = fullKelly * kellyFrac * evThrottle;
