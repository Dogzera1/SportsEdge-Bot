...
function esportsPreFilter(match, odds, enrich, hasLiveStats, gamesContext, compScore, stmts = null, opts = {}) {
  ...
  if (hasComp) {
    ...
    if (maxEdge < 3.0) return { pass: false, direction: null, score: maxEdge, t1Edge, t2Edge, modelP1, modelP2, modelP1Raw, rawEdge, scorePoints, impliedP1, impliedP2, factorCount, factorActive };
