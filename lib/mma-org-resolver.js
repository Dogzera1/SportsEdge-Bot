...
async function _espnLookup(f1, f2, dateIso) {
  ...
  // 2026-05-14: amplia org coverage. ONE Championship adicionado.
  // LFA/Oktagon não têm endpoint ESPN dedicated — Sofascore primary cobre via
  // sport=mma scheduled-events (todos orgs). _espnLookup é fallback.
  const sources = [
    ...
    { org: 'ONE',      path: `/apis/site/v2/sports/mma/one/scoreboard?dates=${range}` },
