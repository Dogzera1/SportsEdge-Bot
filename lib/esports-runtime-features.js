...
function matchStage(league) {
  ...
  if (intlPrefix) {
    return finalish ? 'international_final' : 'international';
  }
 ...
 *   international_final → 1.15 (Worlds/MSI final — peak stakes)
 *   international       → 1.10 (grupos/playoffs internacionais)
 *   regional_final      → 1.08 (LEC/LCK/LPL/LCS Summer Final)
 *   playoffs            → 1.05 (bracket regional)
 *   regular             → 1.00
 */
