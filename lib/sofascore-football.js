...
async function enrichMatch(team1, team2, commenceIso) {
  ...
  log('INFO', 'SOFASCORE', `enrichMatch start: ${team1} vs ${team2} | hasProxy=${hasProxy} envFb="${envFb}" enabled=${enabled} proxyBase="${(process.env.SOFASCORE_PROXY_BASE || '').slice(0, 60)}"`);
