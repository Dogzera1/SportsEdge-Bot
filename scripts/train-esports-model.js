...
// Patch features (só LoL; populado via lib/lol-patches.js + data/lol-patch-dates.json)
const LOL_PATCH_FEATURES = ['days_since_patch', 'post_patch_window'];
...
if ((GAME === 'cs' || GAME === 'cs2') && headers.includes('cs_rank_diff')) NUM_FEATURES = [...NUM_FEATURES, ...CS2_FEATURES];
if (GAME === 'lol' && headers.includes('days_since_patch')) NUM_FEATURES = [...NUM_FEATURES, ...LOL_PATCH_FEATURES];
